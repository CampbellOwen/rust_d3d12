...
use windows::Win32::Graphics::Direct3D12::{
    D3D12CreateDevice, D3D12SerializeRootSignature, ID3D12CommandAllocator, ID3D12CommandList,
    ID3D12CommandQueue, ID3D12DescriptorHeap, ID3D12Fence, ID3D12GraphicsCommandList,
    ID3D12PipelineState, ID3D12Resource, ID3D12RootSignature, D3D12_BLEND_DESC, D3D12_BLEND_ONE,
    ...
    D3D12_HEAP_TYPE_UPLOAD, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, D3D12_INPUT_ELEMENT_DESC,
    ...
    D3D12_RESOURCE_DIMENSION, D3D12_RESOURCE_DIMENSION_BUFFER, D3D12_RESOURCE_STATES,
...
use windows::Win32::Graphics::Dxgi::{
    IDXGIAdapter1, IDXGIDevice, IDXGISwapChain3, DXGI_ADAPTER_FLAG_NONE,
    DXGI_ADAPTER_FLAG_SOFTWARE, DXGI_MWA_NO_ALT_ENTER, DXGI_SWAP_CHAIN_DESC1,
    DXGI_SWAP_EFFECT_FLIP_DISCARD, DXGI_USAGE_RENDER_TARGET_OUTPUT,
};
use windows::Win32::Graphics::{
    Direct3D12::{D3D12GetDebugInterface, ID3D12Debug, ID3D12Device},
    Dxgi::{CreateDXGIFactory2, IDXGIFactory5, DXGI_ADAPTER_FLAG, DXGI_CREATE_FACTORY_DEBUG},
};
